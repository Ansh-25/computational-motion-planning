...
% *******************************************************************
% pairawise checking by choosing 1 side and its opposite vertex .
    flag = true;
    for k = 1:2         % iterate over P1 and P2
        ...
        for i = 1:size(n,1)
            ...
            % First, these vertices must be on the same side, and 2nd
            % they must be on the opposite side.
